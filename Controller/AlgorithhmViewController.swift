   ...
   public override func viewDidLoad() -> Void
    ...
    private func formatAlgorithm() -> Void
    {
        ...
        for step in algorithm
        {
            ...
            let attributedStringStep : NSAttributedString = NSMutableAttributedString(string: formattedStep)
            let outlineStyle = createOutlineStyle()
            
            attributedStringStep.attributes([NSAttributedStringKey.paragraphStyle : outlineStyle], range: NSMakeRange(0,attributedStringStep.length))
